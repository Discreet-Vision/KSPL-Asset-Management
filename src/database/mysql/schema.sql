-- ============================================================
-- KSPL ITAM Enterprise SaaS - Complete Production MySQL Schema (cPanel Compatible)
...
-- ============================================================
-- INITIAL DATA SEEDING (100% IDEMPOTENT)
-- ============================================================

-- Seed Platform Global Tenant
INSERT INTO `organizations` (`id`, `name`, `code`, `region`, `status`)
VALUES ('tenant-platform-global', 'Uclik Technologies (Platform Global)', 'UCLIK-SUPER', 'US', 'Active')
ON DUPLICATE KEY UPDATE `name` = VALUES(`name`);

-- Seed Primary Client Organization (Kubernesis Security HQ)
INSERT INTO `organizations` (`id`, `name`, `code`, `region`, `status`)
VALUES ('tenant-1', 'Kubernesis Security Pvt. Ltd.', 'KSPL-HQ', 'US', 'Active')
ON DUPLICATE KEY UPDATE `name` = VALUES(`name`);
